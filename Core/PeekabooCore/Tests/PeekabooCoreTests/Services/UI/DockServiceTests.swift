...
struct DockServiceTests {
    ...
    @MainActor
    func testListDockItemsIncludeAll() async throws {
        let service = DockService()
    ...
    @MainActor
    func testFindNonExistentDockItem() async throws {
        let service = DockService()
    ...
    @MainActor
    func testDockAutoHideState() async throws {
        let service = DockService()
    ...
    @MainActor
    func testAddAndRemoveFromDock() async throws {
        let service = DockService()
    ...
    @MainActor
    func testDockItemProperties() async throws {
        let service = DockService()
