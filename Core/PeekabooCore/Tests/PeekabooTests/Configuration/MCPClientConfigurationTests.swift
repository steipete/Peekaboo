...
struct MCPClientConfigurationTests {
    ...
    func testMCPClientConfigDefaults() {
    ...
    func testMCPClientConfigCustom() {
    ...
    func testToolDisplayConfigDefaults() {
    ...
    func testToolDisplayConfigCustom() {
        let config = Configuration.ToolDisplayConfig(
    ...
    func testConfigurationWithMCPFields() {
        let mcpClients = [
    ...
    func testMCPClientConfigCodable() throws {
    ...
    func testToolDisplayConfigCodable() throws {
    ...
    func testCompleteConfigurationCodable() throws {
        let mcpClients = [
    ...
    func testMCPServerConfigTypeAlias() {
    ...
    func testConfigurationJSONStructure() throws {
        let config = Configuration(
            mcpClients: [
                "github": Configuration.MCPClientConfig(
                    command: "npx",
