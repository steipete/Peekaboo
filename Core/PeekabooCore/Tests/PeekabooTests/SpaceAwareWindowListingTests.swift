...
struct SpaceAwareWindowListingTests {
    ...
    func testServiceWindowInfoSpaceProperties() {
    ...
    func testServiceWindowInfoEquality() {
    ...
    func testServiceWindowInfoNilSpace() {
        let windowInfo = ServiceWindowInfo(
            windowID: 1234,
            title: "Test Window",
            bounds: CGRect(x: 100, y: 100, width: 800, height: 600)
    ...
    func testServiceWindowInfoCodable() throws {
        let windowInfo = ServiceWindowInfo(
            windowID: 1234,
            title: "Test Window",
            bounds: CGRect(x: 100, y: 100, width: 800, height: 600),
    ...
    func testSpaceManagementServiceWindowSpaces() {
    ...
    func testSpaceManagementServiceCurrentSpace() {
        let spaceService = SpaceManagementService()
    ...
    func testWindowGroupingBySpace() {
