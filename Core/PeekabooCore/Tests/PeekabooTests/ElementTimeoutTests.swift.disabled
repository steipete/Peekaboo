...
struct ElementTimeoutTests {
    ...
    @MainActor
    func windowsWithTimeoutRespectsShortTimeout() async throws {
        // Given
    ...
    @MainActor
    func menuBarWithTimeoutReturnsMenuBar() async throws {
        // Given
        guard let app = NSWorkspace.shared.runningApplications.first(where: {
    ...
    @MainActor
    func aXTimeoutConfiguration() async throws {
    ...
    @MainActor
    func timeoutWrapperWithCancellation() async throws {
        // Given
    ...
    @MainActor
    func timeoutWrapperCompletesBeforeTimeout() async throws {
        // Given/When
