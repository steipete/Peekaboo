...
struct MCPToolRegistryTests {
    ...
    func testRegisterSingleTool() async {
        let registry = await MCPToolRegistry()
    ...
    func testToolOverwriting() async {
        let registry = await MCPToolRegistry()
    ...
    func testToolInfoConversion() async {
        let registry = await MCPToolRegistry()
    ...
    func testRegistryThreadSafety() async {
        let registry = await MCPToolRegistry()
    ...
    func testEmptyRegistryToolInfos() async {
        let registry = await MCPToolRegistry()
...
struct MCPToolRegistryIntegrationTests {
    ...
    func testRegisterAllPeekabooTools() async {
        let registry = await MCPToolRegistry()
    ...
    func testToolInfoSchemaValidation() async {
        let registry = await MCPToolRegistry()
