...
struct MCPToolDescriptionTests {
    ...
    func testToolDescriptionsIncludeMetadata() {
        let tools: [MCPTool] = [
            ImageTool(),
            SeeTool(),
            ClickTool(),
    ...
    func testToolNamingConventions() {
        let tools: [MCPTool] = [
            ImageTool(),
            AnalyzeTool(),
            ListTool(),
