...
public enum CompletionTools {
        ...
        Tool(
            ...
            parameters: .object(
                properties: [
                    ...
                    "success": .boolean(description: "Whether all tasks were completed successfully"),
                    "next_steps": .string(description: "Optional suggestions for follow-up actions")
                ],
    ...
    public static func createNeedInfoTool<Context>() -> Tool<Context> {
        Tool(
            ...
            parameters: .object(
                properties: [
                    "question": .string(description: "The specific question or clarification needed"),
                    "context": .string(description: "Why this information is needed")
                ],
