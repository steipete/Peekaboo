...
public final class CoordinateTransformer {
    ...
    public func transform(
        ...
        let normalized = normalize(bounds, from: sourceSpace)
        
        // Then convert from normalized to target
        return denormalize(normalized, to: targetSpace)
    }
    ...
    public func transform(
        ...
        let transformed = transform(bounds, from: sourceSpace, to: targetSpace)
