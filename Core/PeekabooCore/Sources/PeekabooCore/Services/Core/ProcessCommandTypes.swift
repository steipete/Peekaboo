...
public enum ProcessCommandParameters: Codable, Sendable {
    ...
    public struct ClickParameters: Codable, Sendable {
        ...
        public init(x: Double? = nil, y: Double? = nil, label: String? = nil, 
                   app: String? = nil, button: String? = nil, modifiers: [String]? = nil) {
            self.x = x
            self.y = y
            self.label = label
            self.app = app
    ...
    public struct ResizeWindowParameters: Codable, Sendable {
        ...
        public init(width: Int? = nil, height: Int? = nil, x: Int? = nil, y: Int? = nil, 
                   app: String? = nil, maximize: Bool? = nil, minimize: Bool? = nil) {
            self.width = width
            self.height = height
            self.x = x
            self.y = y
...
public enum ProcessCommandOutput: Codable, Sendable {
    ...
    public struct ElementOutput: Codable, Sendable {
        ...
        public init(label: String?, identifier: String?, type: String, 
                   frame: CGRect, isEnabled: Bool, isFocused: Bool) {
            self.label = label
            self.identifier = identifier
            self.type = type
            self.frame = frame
    ...
    public struct WindowOutput: Codable, Sendable {
        ...
        public init(title: String?, app: String, frame: CGRect, 
                   isMinimized: Bool, isMainWindow: Bool) {
            self.title = title
            self.app = app
            self.frame = frame
