...
/// Refactored DragCommand using PeekabooCore services
/// Performs drag and drop operations using intelligent element finding and service-based architecture.
@available(macOS 14.0, *)
struct DragCommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "drag-v2",
        abstract: "Perform drag and drop operations using PeekabooCore services",
        discussion: """
        This is a refactored version of the drag command that uses PeekabooCore services
        ...
        EXAMPLES:
          ...
          peekaboo drag-v2 --from-coords "100,200" --to-coords "400,300"

          # Drag to an application
          peekaboo drag-v2 --from B1 --to-app Trash

          # Slow drag for precise operations
          peekaboo drag-v2 --from S1 --to-coords "500,250" --duration 2000

          # Multi-select with modifier keys
          peekaboo drag-v2 --from T1 --to T5 --modifiers shift
        """,
        version: "2.0.0")
    ...
    mutating func run() async throws {
        ...
        do {
            ...
            if jsonOutput {
                ...
                print("⏱️  Duration: \(duration)ms with \(steps) steps")
    ...
    private func findApplicationPoint(_ appName: String) async throws -> CGPoint {
        ...
        do {
            let app = try await services.applications.findApplication(identifier: appName)
