...
struct ListCommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        SYNOPSIS:
          peekaboo list-v2 SUBCOMMAND [OPTIONS]

        EXAMPLES:
          peekaboo list-v2                                  # List all applications (default)
          peekaboo list-v2 apps                             # List all running applications
          peekaboo list-v2 apps --json-output               # Output as JSON

          peekaboo list-v2 windows --app Safari             # List Safari windows
          peekaboo list-v2 windows --app "Visual Studio Code"
          peekaboo list-v2 windows --app Chrome --include-details bounds,ids

          peekaboo list-v2 permissions                      # Check permissions
        ...
        """,
        subcommands: [AppsSubcommandV2.self, WindowsSubcommandV2.self, PermissionsSubcommandV2.self],
        defaultSubcommand: AppsSubcommandV2.self)
...
struct AppsSubcommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "apps",
...
struct WindowsSubcommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "windows",
...
struct PermissionsSubcommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
