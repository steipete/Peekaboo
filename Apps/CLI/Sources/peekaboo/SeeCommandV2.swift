...
struct SeeCommandV2: AsyncParsableCommand, VerboseCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: """
            ...
            EXAMPLES:
              peekaboo see-v2                           # Capture frontmost window
              peekaboo see-v2 --app Safari              # Capture Safari window
              peekaboo see-v2 --mode screen             # Capture entire screen
              peekaboo see-v2 --window-title "GitHub"   # Capture specific window
              peekaboo see-v2 --annotate                # Generate annotated screenshot
              peekaboo see-v2 --analyze "Find login"    # Capture and analyze
    ...
    mutating func run() async throws {
        ...
        let startTime = Date()
        Logger.shared.verbose("Starting see-v2 command execution")
