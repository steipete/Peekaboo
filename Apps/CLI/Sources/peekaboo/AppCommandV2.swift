...
struct AppCommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        EXAMPLES:
          ...
          peekaboo app-v2 launch "Visual Studio Code"
          peekaboo app-v2 launch --bundle-id com.microsoft.VSCode --wait-until-ready

          # Quit applications
          peekaboo app-v2 quit --app Safari
          peekaboo app-v2 quit --all --except "Finder,Terminal"

          # Hide/show applications
          peekaboo app-v2 hide --app Slack
          peekaboo app-v2 unhide --app Slack

          # Switch between applications
          peekaboo app-v2 switch --to Terminal
          peekaboo app-v2 switch --cycle  # Cmd+Tab equivalent
        """,
        subcommands: [
            LaunchSubcommandV2.self,
            QuitSubcommandV2.self,
            HideSubcommandV2.self,
            UnhideSubcommandV2.self,
            SwitchSubcommandV2.self,
    ...
    struct QuitSubcommandV2: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "quit",
    ...
    struct UnhideSubcommandV2: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "unhide",
    ...
    struct SwitchSubcommandV2: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "switch",
