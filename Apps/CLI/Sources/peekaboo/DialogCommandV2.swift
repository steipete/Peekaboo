...
struct DialogCommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "dialog-v2",
        ...
        EXAMPLES:
          ...
          peekaboo dialog-v2 click --button "OK"
          peekaboo dialog-v2 click --button "Don't Save"

          # Type in a dialog text field
          peekaboo dialog-v2 input --text "password123" --field "Password"

          # Handle file dialogs
          peekaboo dialog-v2 file --path "/Users/me/Documents/file.txt"
          peekaboo dialog-v2 file --name "report.pdf" --select "Save"

          # Dismiss dialogs
          peekaboo dialog-v2 dismiss
          peekaboo dialog-v2 dismiss --force  # Press Escape
        """,
        subcommands: [
            ClickSubcommandV2.self,
            InputSubcommandV2.self,
            FileSubcommandV2.self,
            DismissSubcommandV2.self,
    ...
    struct InputSubcommandV2: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "input",
    ...
    struct FileSubcommandV2: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "file",
    ...
    struct DismissSubcommandV2: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "dismiss",
