...
struct SwipeCommandV2: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "swipe-v2",
        ...
        EXAMPLES:
          ...
          peekaboo swipe-v2 --from B1 --to B5 --session-id 12345

          # Swipe with coordinates
          peekaboo swipe-v2 --from-coords 100,200 --to-coords 300,400

          # Mixed mode: element to coordinates
          peekaboo swipe-v2 --from T1 --to-coords 500,300 --duration 1000

          # Slow swipe for precise gesture
          peekaboo swipe-v2 --from-coords 50,50 --to-coords 400,400 --duration 2000
