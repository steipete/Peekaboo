//
//  DetailedMenuSystemToolFormatter.swift
//  Peekaboo
//
...
/// Detailed formatter for menu, dialog, and system tools with comprehensive result formatting
class DetailedMenuSystemToolFormatter: BaseToolFormatter {
