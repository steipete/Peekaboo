//
//  DetailedToolFormatterRegistry.swift
//  Peekaboo
//

import Foundation

/// Detailed registry for tool formatters with comprehensive result formatting
public final class DetailedToolFormatterRegistry: @unchecked Sendable {
    
    // Singleton instance for global access
    public static let shared = DetailedToolFormatterRegistry()
