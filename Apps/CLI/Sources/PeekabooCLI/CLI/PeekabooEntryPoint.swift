...
/// Generate the dynamic permissions section for help output.
...
public struct Peekaboo: ParsableCommand {
    public init() {}
...
public func runPeekabooCLI() async {
    ...
    if await CommanderPilot.tryRun(arguments: CommandLine.arguments) {
        return
    }
