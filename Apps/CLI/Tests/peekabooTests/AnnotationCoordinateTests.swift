...
struct AnnotationCoordinateTests {
    ...
    func testWindowRelativeTransformation() {
    ...
    func testCompleteTransformationPipeline() {
    ...
    func testAnnotationFilePathGeneration() {
        let testPaths = [
    ...
    func testElementFilteringForAnnotation() {
        // Create test elements
        let enabledButton = createTestElement(id: "B1", isEnabled: true)
        let disabledButton = createTestElement(id: "B2", isEnabled: false)
        let enabledTextField = createTestElement(id: "T1", isEnabled: true, type: .textField)
        let disabledLink = createTestElement(id: "L1", isEnabled: false, type: .link)
