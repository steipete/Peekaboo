...
struct AgentExecutorTests {
    ...
    func executeSeeCommand() async throws {
        ...
        do {
            ...
            #expect(responseData?["screenshot_raw"] as? String != nil)
            #expect(responseData?["session_id"] as? String != nil)
    ...
    func executeDragCommand() async throws {
        ...
        do {
            ...
            #expect(json["success"] as? Bool == true)
            let responseData = json["data"] as? [String: Any]
            #expect(responseData?["from"] as? [String: Double] != nil)
            #expect(responseData?["to"] as? [String: Double] != nil)
        } catch {
            #expect(error is AgentError || error is PeekabooCore.UIAutomationError)
        }
    }
    ...
    func executeListAppsCommand() async throws {
        ...
        #expect(json["success"] as? Bool == true)
        let responseData = json["data"] as? [String: Any]
        #expect(responseData?["applications"] as? [[String: Any]] != nil)
