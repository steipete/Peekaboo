...
struct ApplicationToolFormatter: MacToolFormatterProtocol {
    ...
    func formatSummary(toolName: String, arguments: [String: Any]) -> String? {
        switch toolName {
        case "launch_app":
            return formatLaunchAppSummary(arguments)
        case "list_apps":
            return "List running applications"
        case "focus_window":
            return formatFocusWindowSummary(arguments)
        case "list_windows":
            return formatListWindowsSummary(arguments)
        case "resize_window":
            return formatResizeWindowSummary(arguments)
        default:
            return nil
        }
    }
