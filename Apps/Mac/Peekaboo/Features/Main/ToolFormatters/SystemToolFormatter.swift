...
struct SystemToolFormatter: MacToolFormatterProtocol {
    ...
    func formatSummary(toolName: String, arguments: [String: Any]) -> String? {
        switch toolName {
        case "shell":
            self.formatShellSummary(arguments)
        case "wait":
            self.formatWaitSummary(arguments)
        case "list_spaces":
            "List desktop spaces"
        case "switch_space":
            self.formatSwitchSpaceSummary(arguments)
        case "move_window_to_space":
            self.formatMoveWindowToSpaceSummary(arguments)
        case "list_screens":
            "List displays"
        default:
            nil
    ...
    func formatResult(toolName: String, result: [String: Any]) -> String? {
        ...
        case "move_window_to_space":
            self.formatMoveWindowResult(result)
        case "list_screens":
