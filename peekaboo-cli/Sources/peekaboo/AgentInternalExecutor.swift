...
struct AgentInternalExecutor {
    ...
    func executeFunction(name: String, arguments: String) async throws -> String {
        ...
        do {
            guard let parsed = try JSONSerialization.jsonObject(with: argsData) as? [String: Any] else {
                return createErrorJSON(.invalidArguments("Arguments must be a JSON object"))
            }
            args = parsed
        } catch {
    ...
    private func executeSee(args: [String: Any]) async throws -> String {
        ...
        return result.isEmpty ? createSuccessJSON("Screenshot captured") : result
    }
    ...
    private func executeClick(args: [String: Any]) async throws -> String {
        ...
        let result = output.stop()
        return result.isEmpty ? createSuccessJSON("Click executed") : result
    }
    ...
    private func executeType(args: [String: Any]) async throws -> String {
        ...
        let result = output.stop()
        return result.isEmpty ? createSuccessJSON("Text typed") : result
    }
    ...
    private func executeApp(args: [String: Any]) async throws -> String {
        ...
        case "launch":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("App launched") : result
        ...
        case "quit":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("App quit") : result
        ...
        case "focus", "switch":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("App focused") : result
        ...
        case "hide":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("App hidden") : result
        ...
        case "unhide":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("App unhidden") : result
    ...
    private func executeWindow(args: [String: Any]) async throws -> String {
        ...
        case "close":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("Window closed") : result
        ...
        case "minimize":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("Window minimized") : result
        ...
        case "maximize":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("Window maximized") : result
        ...
        case "focus":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("Window focused") : result
        ...
        case "move":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("Window moved") : result
        ...
        case "resize":
            ...
            let result = output.stop()
            return result.isEmpty ? createSuccessJSON("Window resized") : result
    ...
    private func executeImage(args: [String: Any]) async throws -> String {
        ...
        let result = output.stop()
        return result.isEmpty ? createSuccessJSON("Image captured") : result
    }
    ...
    private func executeHotkey(args: [String: Any]) async throws -> String {
        ...
        let result = output.stop()
        return result.isEmpty ? createSuccessJSON("Hotkey pressed") : result
    }
    ...
    private func executeScroll(args: [String: Any]) async throws -> String {
        ...
        let result = output.stop()
        return result.isEmpty ? createSuccessJSON("Scrolled") : result
    }
...
final class CaptureOutput: @unchecked Sendable {
    ...
    func stop() -> String {
        guard let oldStdout = oldStdout else { return "" }
