...
enum PeekabooMenuError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .submenuNotFound(let menu):
            return "Submenu '\(menu)' not found"
        case .menuExtraNotFound(let extra):
...
private extension Element {
    ...
    func attributedTitle() -> NSAttributedString? {
        ...
        if let attrTitle = self.value() as? NSAttributedString {
            return attrTitle
        }
        return nil
    }
    ...
    func keyboardShortcut() -> String? {
        ...
        if let cmdChar = self.attribute(Attribute<String>("AXMenuItemCmdChar")),
           let modifiers = self.attribute(Attribute<Int>("AXMenuItemCmdModifiers")) {
