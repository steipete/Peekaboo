...
struct WindowCommandCLITests {
    ...
    func testWindowHelpOutput() async throws {
    ...
    func testWindowCloseHelp() async throws {
    ...
    func testWindowMoveHelp() async throws {
    ...
    func testWindowResizeHelp() async throws {
    ...
    func testWindowListDelegation() async throws {
    ...
    func testMissingAppParameter() async throws {
        do {
    ...
    func testInvalidWindowIndex() async throws {
        let output = try await runCommand(["window", "close", "--app", "Finder", "--window-index", "999", "--json-output"])
...
@Suite("Window Command Integration Tests", .enabled(if: ProcessInfo.processInfo.environment["RUN_LOCAL_TESTS"] == "true"))
struct WindowCommandLocalTests {
    
    @Test("Window operations with TextEdit")
    func testTextEditWindowOperations() async throws {
