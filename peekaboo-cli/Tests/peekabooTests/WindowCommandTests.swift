...
struct WindowCommandTests {
    ...
    @Test
    func testWindowCommandHelp() async throws {
    ...
    @Test
    func testWindowListCommand() async throws {
    ...
    @Test
    func testWindowCommandWithoutApp() async throws {
    ...
    @Test
    func testWindowMoveRequiresCoordinates() async throws {
        do {
    ...
    @Test
    func testWindowResizeRequiresDimensions() async throws {
        do {
    ...
    @Test
    func testWindowSetBoundsRequiresAllParameters() async throws {
        do {
    ...
    enum TestError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .commandFailed(let status, let output):
                return "Command failed with exit status: \(status). Output: \(output)"
            }
        }
    }
}
...
struct WindowCommandLocalIntegrationTests {
    ...
    func testWindowMinimizeTextEdit() async throws {
    ...
    @Test(.enabled(if: ProcessInfo.processInfo.environment["RUN_LOCAL_TESTS"] == "true"))
    func testWindowMoveTextEdit() async throws {
        // This test requires TextEdit to be running and local permissions
    ...
    @Test(.enabled(if: ProcessInfo.processInfo.environment["RUN_LOCAL_TESTS"] == "true"))
    func testWindowFocusTextEdit() async throws {
