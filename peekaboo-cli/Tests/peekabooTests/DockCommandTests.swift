...
struct DockCommandTests {
    ...
    func testDockClickHelp() async throws {
    ...
    func testDockRightClickHelp() async throws {
    ...
    func testDockHideShow() async throws {
    ...
    func testDockListHelp() async throws {
...
struct DockCommandIntegrationTests {
    ...
    func testClickDockItemByName() async throws {
        let output = try await runCommand([
            "dock", "click",
            "--app", "Finder",
            "--json-output"
    ...
    func testHideShowDock() async throws {
        // Hide Dock
    ...
    func testListDockItemsByType() async throws {
        // List only apps
