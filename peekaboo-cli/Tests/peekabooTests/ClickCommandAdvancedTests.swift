...
struct ClickCommandAdvancedTests {
    ...
    func testTextBasedClickParsing() async throws {
    ...
    func testCoordinateClickParsing() async throws {
    ...
    func testElementIDClickParsing() async throws {
    ...
    func testDoubleClickParsing() async throws {
    ...
    func testRightClickParsing() async throws {
    ...
    func testElementLocatorFromQuery() {
        // Text content search
    ...
    func testClickResultJSON() throws {
    ...
    func testClickTargetPriority() throws {
...
struct ClickCommandMockTests {
    ...
    @MainActor
    func testClickLocationValidation() {
...
extension ClickCommand {
    ...
    @MainActor
    static func findElementByText(_ text: String, in sessionData: SessionData) -> SessionData.UIElement? {
        let lowerText = text.lowercased()
        
        return sessionData.uiMap.first { element in
    ...
    static func isValidClickLocation(_ location: CGPoint, windowBounds: CGRect) -> Bool {
        return windowBounds.contains(location)
    }
}