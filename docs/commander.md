...
2. **Dual-Wire PeekabooCLI**
   ...
   - 🔄 *In progress: initial `CommanderRegistryBuilder` now exports descriptors/signatures for every command so we can start routing Commander without disturbing execution.*
