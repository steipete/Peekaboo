...
- App launch/switch and window focus commands now invalidate the implicit latest snapshot after focus changes.
...
- done: invalidate implicit latest snapshots after app launch/switch and window focus changes;
