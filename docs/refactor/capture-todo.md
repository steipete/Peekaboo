...
- [ ] **Docs sweep**: ensure no stale “watch” mentions remain outside the updated capture docs (visualizer/cli helpers).
- [ ] **Full test run**: previous `swift test` timed out at 120s; rerun with higher timeout or targeted suites when feasible.
