...
3. **AXorcist observability hook** (done via fallback runner logging) — optional follow-up: expose a public `ScreenCaptureMetricsObserving` if we decide to ship metrics beyond logging; otherwise, remove TODO references.
