summary: "Legacy Peekaboo Menu Bar Specification (pre-3.0)"
read_when:
  - Auditing legacy Peekaboo menu bar specs or planning refactors
---

# Peekaboo Menu Bar App Specification (Legacy)

> **Status:** superseded by [`docs/specv3.md`](../specv3.md). Keep this file only for historical reference when revisiting early menu bar concepts.
