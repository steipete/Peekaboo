...
- Schedule a dedicated fix for `VisualizationClient.isVisualFeedbackEnabled(reply:)` (likely move the XPC callback onto the main actor) so tmux builds can finish.
